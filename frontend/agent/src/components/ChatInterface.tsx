...
// // import { useState, useRef, useEffect } from "react";
// // import { Send, Upload, MessageSquare, Loader2, Database } from "lucide-react";
// // import ChatMessage from "./ChatMessage";
...
// // const INGEST_API = "http://127.0.0.1:8080/ingest-multiple";
...
// //       const end = Date.now();
// //       const seconds = ((end - startTimeRef.current) / 1000).toFixed(2);
...
// //           {
// //             role: "assistant",
// //             content: "✅ Documents successfully ingested.",
// //           },
// //         ]);
...
// //       <div className="px-6 py-4 border-b border-border/50 flex items-center justify-between">
// //         <div className="flex items-center gap-3">
// //           <img src="./fav.png" alt="LaunchPAD Logo" className="w-6 h-6" />
// //           <h1 className="font-display text-lg tracking-wider text-foreground text-glow-primary">
// //             LaunchPAD ALTIMETRIK
// //           </h1>
// //         </div>
...
// //       </div>
// // {/* Messages */}
// //       <div ref={scrollRef} className="flex-1 flex flex-col overflow-y-auto p-6">
// //         {messages.length === 0 && (
// //           <div className="flex flex-col items-center justify-center h-full text-center gap-4">
// //             <div className="w-16 h-16 rounded-2xl bg-primary/10 border border-primary/30 flex items-center justify-center animate-float">
// //               {mode === "query" ? (
...
// //               placeholder="Type your message..."
// //               className="flex-1 bg-muted/50 border border-border/50 rounded-xl px-4 py-3 text-sm"
// //             />

// //             <button
// //               onClick={sendQuery}
// //               disabled={!input.trim() || loading}
// //               className="bg-primary/20 hover:bg-primary/30 border border-primary/40 text-primary rounded-xl px-4"
// //             >
// //               <Send className="w-4 h-4" />
// //             </button>
// //           </div>
...
// //               className="bg-secondary/20 hover:bg-secondary/30 border border-secondary/40 text-secondary rounded-xl px-4 py-3"
// //             >
// //               <Upload className="w-4 h-4" />
// //             </button>
// //           </div>
...
//       <div
//   ref={scrollRef}
//   className="flex-1 flex flex-col overflow-y-scroll no-scrollbar p-6 relative"
// >
...
export default function ChatInterface() {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto h-[85vh] flex flex-col glass-panel cyber-border rounded-2xl overflow-hidden animate-fade-in">
      ...
      <div
        ref={scrollRef}
        className="flex-1 flex flex-col overflow-y-auto no-scrollbar p-6 relative"
